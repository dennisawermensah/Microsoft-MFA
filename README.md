...
<p align="center">
<img src="https://i.imgur.com/h4y0Hqr.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/><br>
<img src="https://i.imgur.com/VVDliXy.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>

<br />
<br />
  
3. Activate Azure AD Premium P2 trial<br>
...
III. On the left pane, click on 'Licenses' under 'Manage'<br>
<p align="center">
<img src="https://i.imgur.com/79D9Aq9.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />
  
IV. Click on 'All products', '+Try/Buy', 'Free Trial' and 'Activate'<br>
<p align="center">
...
5. Assigning Azure AD premuim to users <br>
...
IV. cilck on 'Add users and groups', select users, 'review + assign'<br>
<p align="center">
...
4. New tab opens <br>
i. click on service settings. Ensure all verification options are checked, click save <br>
<p align="center">
<img src="https://i.imgur.com/qPGtei0.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />
  
ii. click on user tab, select users , click on enable, click on 'enable mulifactor auth' <br>
<p align="center">
<img src="https://i.imgur.com/qPGtei0.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />
  
5. Click on 'Fraud alert', turn all alerts 'on' <br>
<p align="center">
<img src="https://i.imgur.com/rX5q8tK.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />
  
6. open private mode browsing. sign-in with user 1 account.  <br>
  
7. select 'different method of athentification', then choose <br>
<p align="center">
<img src="https://i.imgur.com/ecaGC97.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />

7. Implementing Azure AD Conditional Access Policies <br>
1.Still in the new directory.<br>
  
2. click on'Security' then 'Conditional Access', 'Polices' '+New Policy'<br>
<p align="center">
...
3. Fill in the details, select specific users included, Select all the needed policies and controls,'enable policy on'  then 'Create <br>
<p align="center">
<img src="https://i.imgur.com/NP8Tp71.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />

6. Test it out by signing in using user 2 credentials<br>

8. Impementing Azure AD Identity Protection<br>
1. Click on 'Security', 'Identity Protection'. 'User risk policy', Set configurations, 'enable policy' then 'Save'.<br>
<p align="center">
<img src="https://i.imgur.com/Hkp4Kxt.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />
  
3. Configure Sign-in-risk in the same way as User risk policy<br>


9. : Simulate risk events against the Azure AD Identity Protection policies<br>
1. Switch to the directory where the VM was deployed<br>

2. select the VM, click on 'Connect' select 'RDP'<br>
<p align="center">
...
4. Launch RDP and connect with credentials used for creating the VM<br>
5. Set IEE Security to OFF.<br>
<p align="center">
<img src="https://i.imgur.com/5yifPjt.png" height="80%" width="80%" alt="Create a new tenant in Azure Active Directory"/>
<br />
<br />
  
6 inPrivaate mode sign-in to user 3. it gets blcked because of Sign-in risk policy<br>
<p align="center">
...
7. Analyse Reports of risks in the new directory that was created<br>
<p align="center">
